...
?>
          ...
          <div class="nav-sticky">
            ...
            <nav class="nav-categories">
              <ul class="side-box">
                ...
                <ul class="side-box" data-sidetitle="Kategoriler">
                  <li>
                    <a href="#iam">
                      <svg class="icon">
                        <use xlink:href="#icon-home" />
    ...
    <div class="nothing-else-matter">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" style="display: none;">
          ...
          <!-- NAVBAR -->
          <!-- Cogs Icon -->
          <symbol id="icon-cogs" viewBox="0 0 64 64" enable-background="new 0 0 64 64" fill="currentColor">
            <circle cx="32" cy="32" r="4.167"></circle>
            <path
          ...
          <!-- Search Icon -->
          <symbol id="icon-search" viewBox="0 0 24 24" enable-background="new 0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" height="21">
            <circle cx="11" cy="11" r="8"></circle>
            <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
          </symbol>
          <!-- Literature Icon -->
          <symbol id="icon-literature" viewBox="0 0 24 24" enable-background="new 0 0 24 24" stroke-linejoin="round"
            stroke-linecap="round" height="21" stroke-width="2" stroke="currentColor" fill="currentColor">
            <line x1="17" y1="10" x2="3" y2="10"></line>
            <line x1="21" y1="6" x2="3" y2="6"></line>
            <line x1="21" y1="14" x2="3" y2="14"></line>
            <line x1="17" y1="18" x2="3" y2="18"></line>
          </symbol>
          <!-- Heart for Music Icon -->
          <symbol id="icon-heart" viewBox="0 0 32 32" enable-background="new 0 0 32 32" y="0px" x="0px"
            stroke-linecap="round" height="21" stroke-width="2" stroke="currentColor" fill="none">
            <path
              d="M16,28c-0.3,0-0.5-0.1-0.7-0.3L3.9,16.4C2.7,15.1,2,13.4,2,11.7c0-1.8,0.7-3.5,1.9-4.7c2.6-2.6,6.8-2.6,9.4,0L16,9.6 l2.6-2.6c2.6-2.6,6.8-2.6,9.4,0c1.3,1.3,1.9,2.9,1.9,4.7c0,1.8-0.7,3.5-1.9,4.7L16.7,27.7C16.5,27.9,16.3,28,16,28z">
            </path>
          </symbol>
          <!-- Games Icon -->
          <symbol id="icon-games" viewBox="0 0 548.176 548.176" enable-background="new 0 0 548.176 548.176" y="0px"
            x="0px" stroke-linecap="round" height="21" stroke-width="2" stroke="currentColor" fill="currentColor">
            ...
            C475.085,247.629,471.516,256.243,464.373,263.38z"></path>
          </symbol>
          <!-- Code for Lab Icon -->
          <symbol id="icon-code" viewBox="0 0 230.795 230.795" enable-background="new 0 0 230.795 230.795" y="0px" x="0px"
            stroke-linecap="round" width="21" stroke-width="2" stroke="currentColor" fill="currentColor">
            ...
            C230.795,113.954,230.005,112.046,228.598,110.639z"></path>
            <path
          ...
          <!-- Bookmark Icon -->
          <symbol id="icon-bookmark" viewBox="0 0 512 512" enable-background="new 0 0 512 512" width="21" height="21"
            fill="currentColor">
            ...
            c0-17.643,14.357-32,32-32h213.333c17.643,0,32,14.357,32,32V475.563z"></path>
          </symbol>
          <!-- Dictionary Icon -->
          <symbol id="icon-dictionary" viewBox="0 0 512 512" enable-background="new 0 0 512 512" width="21" height="21"
            fill="currentColor">
            <path
              d="m419.151 103.09v-73.09h11.661c8.284 0 15-6.716 15-15s-6.716-15-15-15h-306.02c-32.314 0-58.604 26.25-58.604 58.517v413.701c0 21.936 17.869 39.782 39.832 39.782h302.453c20.588 0 37.338-16.73 37.338-37.294v-338.658c.001-16.16-11.444-29.695-26.66-32.958zm-322.963-44.573c0-15.725 12.832-28.517 28.604-28.517h264.359v72.335h-264.359c-15.772 0-28.604-12.792-28.604-28.517zm319.624 416.189c0 4.022-3.292 7.294-7.338 7.294h-302.454c-5.421 0-9.832-4.388-9.832-9.782v-347.338c8.465 4.747 18.224 7.456 28.604 7.456h287.27c2.067 0 3.75 1.666 3.75 3.712z">
            </path>
            <path
              d="m171.618 233.532c-.809-2.521-5.335-7.87-15.438-7.87-11.433 0-14.63 5.349-15.437 7.87l-28.15 92.32c-.821 3.443 1.336 6.56 4.616 8.475 3.278 1.918 6.683 2.876 10.216 2.876 4.337 0 6.91-1.461 7.719-4.389l5.146-18.918h31.934l5.146 18.918c.807 2.928 3.379 4.389 7.719 4.389 3.53 0 6.936-.958 10.216-2.876 3.277-1.915 5.321-5.514 4.616-8.475zm-26.485 62.202 11.048-40.561 11.048 40.561z">
            </path>
            <path
              d="m278.314 277.27c8.575-3.731 12.864-11.653 12.864-23.761 0-17.958-10.09-26.939-30.269-26.939h-31.026c-7.634 0-10.291 4.944-10.291 7.265v96.255c0 1.918 2.907 7.113 10.291 7.113h33.599c9.282 0 16.672-2.597 22.172-7.794 5.499-5.195 8.249-13.444 8.249-24.745v-3.179c0-7.061-1.313-12.384-3.935-15.967-2.625-3.58-6.508-6.33-11.654-8.248zm-35.263-30.117h15.892c8.058 0 8.626 7.771 8.626 10.594 0 2.826-.944 10.442-8.626 10.442h-15.892zm27.242 55.543c0 9.284-4.037 13.924-12.107 13.924h-15.135v-30.269h15.135c8.071 0 12.107 4.642 12.107 13.924z">
            </path>
            <path
              d="m352.775 247.153c8.676 0 13.167 4.54 13.469 13.621.303 4.743 4.238 7.113 11.805 7.113 7.076 0 11.805-2.762 11.805-11.2 0-9.383-3.557-16.747-10.669-22.096-7.113-5.347-16.22-8.021-27.318-8.021-10.797 0-19.549 2.875-26.258 8.626-6.711 5.752-10.064 14.782-10.064 27.091v40.106c0 12.312 3.353 21.34 10.064 27.091 6.709 5.751 15.461 8.627 26.258 8.627 11.098 0 20.205-2.823 27.318-8.476 7.113-5.649 10.669-13.368 10.669-23.155 0-5.855-2.479-11.2-11.956-11.2-7.366 0-11.251 2.372-11.654 7.113-.569 5.951-3.744 15.135-13.318 15.135-9.183 0-13.772-5.044-13.772-15.135v-40.106c0-10.088 4.54-15.134 13.621-15.134z">
            </path>
          </symbol>
          <!-- Close Icon -->
          <symbol id="icon-close" viewBox="0 0 352 512" enable-background="new 0 0 352 512" aria-hidden="true"
            focusable="false" role="img" width="53" height="49" fill="currentColor">
            <path fill="currentColor"
              d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z">
            </path>
          </symbol>
          <!-- Arrow Down Icon -->
          <symbol id="icon-arrow-down" viewBox="0 0 451.847 451.847" enable-background="new 0 0 451.847 451.847"
            fill="currentColor">
          ...
          <symbol id="icon-align-justify" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
          ...
          <symbol id="icon-dimension" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <symbol id="icon-column" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
          stroke-linejoin="round">
            <path d="M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7m0-18H5a2 2 0 0 0-2   2v14a2 2 0 0 0 2 2h7m0-18v18" />
          </symbol>
          <symbol id="icon-feather" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z" />
            <line x1="16" y1="8" x2="2" y2="22" />
            <line x1="17.5" y1="15" x2="9" y2="15" />
          </symbol>
          <symbol id="icon-signboard" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <symbol id="icon-volume-up" viewBox="0 0 576 512">
            <path
          ...
          <symbol id="icon-bird" viewBox="0 0 512 512">
            ...
            <path style="fill:#0096DC;"
              d="M411.462,235.301c-59.522,55.914-206.572,88.149-215.637-30.259
        ...
        <nav class="sidemenu">
          <div class="side-wrapper">
            ...
            <div class="side-top">
              <form method="get" name="searchform" id="searchform" action="https://hakkicengiz.com">
                <span class="arama-icon" onclick="searchform.submit()">
                  <svg class="icon" height="21" width="21">
                    <use xlink:href="#icon-search"></use>
                  </svg>
                </span>
                <input type="text" name="s" id="s" class="arama" onfocus="this.placeholder=''" placeholder="">
              </form>
            </div>
            <div class="side-middle" id="side-middle">
              <ul class="nav">
                <header>
                  <h2 class="title">Menu</h2>
                </header>
  
                <li><a href="https://hakkicengiz.com/blog" title="Edebiyat"><svg class="icon">
                      <use xlink:href="#icon-literature"></use>
                    </svg> <span class="trn">Literature</span> </a></li>
                <li><a href="https://hakkicengiz.com/culture" title="Müzik"><svg class="icon">
                      <use xlink:href="#icon-heart"></use>
                    </svg> <span class="trn">Music</span> </a></li>
                <li><a href="https://hakkicengiz.com/oyunlar"><svg class="icon">
                      <use xlink:href="#icon-games"></use>
                    </svg> <span class="trn">Oyunlar</span></a></li>
                <li><a href="#"><svg class="icon">
                      <use xlink:href="#icon-code"></use>
                    </svg> <span class="trn">Yazılım</span> <svg class="icon">
                      <use xlink:href="#icon-arrow-down"></use>
                    </svg></a>
                  <ul class="dropdown" aria-label="submenu">
                    <li><a href="https://hakkicengiz.com/labs">- Laboratuvar (Hepsi)</a> </li>
                    <li><a href="#">- Wordpress Kod Deposu</a></li>
                    <li><a href="#">- HTML Kod Deposu</a></li>
                    <li><a href="#">- CSS Kod Deposu</a></li>
                    <li><a href="#">- JS Kod Deposu</a></li>
                  </ul>
                </li>
                <li><a href="#0"><svg class="icon">
              ...
              <div class="side-middle-alt">
  
                <div class="hc-logo">
                  <a class="hc-title" href="https://hakkicengiz.com" title="kodlarla dövüşen çocuk">
                    <h1>hakkı<span>cengiz</span></h1>
                    <div class="hc-desc">
                ...
                <div class="translator">
                  <span id="translator-en">EN</span>
                  <span id="translator-tr">TR</span>
                </div>
                ...
                <div class="tagcloud">
                  <span>Araçlar:</span>
                  <a href="https://hakkicengiz.com/html-kod-deposu">HTML Kod Deposu</a>
                  <a href="https://hakkicengiz.com/css-kod-deposu">CSS Kod Deposu</a>
                  <a href="https://hakkicengiz.com/js-kod-deposu/">JS Kod Deposu</a>
                  <a href="https://hakkicengiz.com/wordpress-kod-deposu">Wordpress Kod Deposu</a>
                  <a href="https://hakkicengiz.com/">SEO Kod Deposu</a>
                </div>
                <hr>
                <h3>Sayfalar</h3>
                <div class="tagcloud">
                  <a href="https://hakkicengiz.com/author/hkkcngz/">Hakkımda</a>
                  <a href="https://hakkicengiz.com/cv/">CV</a>
                  <a href="#">Rules</a>
                  <a href="#">Privacy</a>
                  <a href="#">Contact</a>
                </div>
                ...
                <h3>Validators</h3>
                <div class="tagcloud">
                  <a onclick="window.location.reload(true)" title="bi ctrl+f5 in halledemeyeceği şey yok.">Sayfa bozuk mu
                    gözüküyo?</a>&nbsp;•&nbsp;
                  <a href="https://validator.w3.org/check/referer" rel="nofollow" class="html5"
                    title="This page validates as HTML5">Valid <abbr title="HyperText Markup Language 5">HTML5</abbr></a>
                  &nbsp;•&nbsp;
                  <a href="https://jigsaw.w3.org/css-validator/check/referer" rel="nofollow" class="css3"
                    title="This page validates as CSS">Valid <abbr title="Cascading Style Sheets 3">CSS3</abbr></a>
                  &nbsp;•&nbsp;
                  <a href="https://gtmetrix.com/reports/hakkicengiz.com/tUiqYwSP" rel="nofollow" class="css3"
                    title="This page validates as Gtmetrix">Valid <abbr title="Gtmetrix">Gtmetrix</abbr></a>
                </div>
  
                <div class="href-target" id="smalt"></div>
              </div>
            </div>
            <div class="side-footer">
  
              <p>© 2009 - 2020 Hakkı Cengiz. <br> One Theme To Rule Them All. <br> Tüm hakları
                saklıdır.</p>
  
              <div onClick="scrollToBottom()" class="side-footer-action">
                <svg class="icon opener-settings">
        ...
        <div class="cookie-alert">
          <img src="<?=$theme?>/images/theme/cookie.png" alt="">
          <div class="content">
    ...
    <script src="<?=$theme?>/assets/js/plugins/video/tilt.jquery.js"></script>
    <script async src="<?=$theme?>/assets/js/plugins/translatejs/jquery.translate.js"></script>
    <script async src="<?=$theme?>/assets/js/plugins/translatejs/dictionary.js"></script>
    <script async src="<?=$theme?>/assets/js/plugins/customtextview.js"></script>
  
    <script src="<?=$theme?>/assets/js/plugins/zuckjs/zuck.min.js"></script>
    <script src="<?=$theme?>/assets/js/plugins/zuckjs/zuck.js"></script>
    <script src="<?=$theme?>/assets/js/plugins/music.js"></script>
    <script src="<?=$theme?>/assets/js/plugins/prism.js"></script>
