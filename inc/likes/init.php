...
{
    wp_enqueue_script('simple-likes-public-js', get_template_directory_uri() . '/inc/likes/simple-likes-public.js', array('jquery'), '0.5', false);
    wp_localize_script('simple-likes-public-js', 'simpleLikes', array(
        'ajaxurl' => admin_url('admin-ajax.php'),
        'like' => __('Çayla'),
        'unlike' => __('Çaysız geç'),
    ));
}
    ...
    if ($post_id != '') {
        ...
        if ($disabled == true) {
            if ($is_comment == 1) {
                ...
                wp_redirect( home_url( $wp->request ) ); // get_permalink($post_id)
                exit();
            }
        } else {
...
function get_liked_icon()
{
    ...
    $icon = '<span class="sl-icon"><img src="' . get_template_directory_uri() . '/images/tools/cay-full-min.png" alt="liked" /></span>';
    return $icon;
} // get_liked_icon()
...
function get_unliked_icon()
{
    ...
    $icon = '<span class="sl-icon"><img src="' . get_template_directory_uri() . '/images/tools/cay-empty-min.png" alt="unliked" /></span>';
    return $icon;
} // get_unliked_icon()
...
{?>
            <table class="form-table">
                <tr>
                    <th><label for="user_likes"><?php _e('Çayladın:', 'editorsel');?></label></th>
                    <td>
                    <?php
